...
# only working one
root4star -b -q -l 'bfcRunner.C( '"$2"', "DbV20150316 y2014a fzin mtdSim tpcX AgML tpcDB TpcHitMover Idst ITTF UseXgeom BAna VFMinuit l3onl emcDY2 fpd trgd ZDCvtx btof mtd mtdCalib BEmcChkStat CorrX OSpaceZ2 OGridLeak3D tpcrs TpxRaw  VFMCE TpxClu big MakeEvent IdTruth McEvent McAss", "'$1'" )'
